/**************************************************************
 * Name: Gurkirat Singh
 * Description: This header file takes in a ostream alias whenever
 *              we need to output anything to a file and has a
 *              bit buffer the size of 8 bits and it is flushed
 *              when 8 have been collected. We write to the file
 *              in bits, not bytes.
 **************************************************************/
