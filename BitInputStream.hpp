/******************************************************************
 * Name: Gurkirat Singh
 * Description: This header file initializes the bit buffer to size
 *              of 8 and holds a byte when a read is called for 
 *              input. Reading bits and bytes is done in form of
 *              bits, hence every bit is read one by one individually.
 *****************************************************************/
