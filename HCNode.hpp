/****************************************************************************
 * Name: Gurkirat Singh
 * Description: This class is responsible for each node in the Huffman tree.
 *              The constructor intializes everything to zero and the class
 *              the frequency, the symbol, the left and right child, and the
 *              parent pointer to each node. The < operator is overloaded
 *              to compare two HCNodes.
 ***************************************************************************/
